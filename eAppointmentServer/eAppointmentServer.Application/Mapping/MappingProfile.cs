...
namespace eAppointmentServer.Application.Mapping
{
    public sealed class MappingProfile : Profile
    {
        ...
        {
            CreateMap<CreateDoctorCommand, Doctor>().ForMember(member => member
            .Department, options => options.MapFrom(map => DepartmentEnum.FromValue(map.DepartmentValue)));

            CreateMap<UpdateDoctorCommand, Doctor>().ForMember(member => member
            .Department, options => options.MapFrom(map => DepartmentEnum.FromValue(map.DepartmentValue)));
